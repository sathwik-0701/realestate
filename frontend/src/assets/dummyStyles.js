...
export const landingPageStyles = {
  ...
  // Hero image
  heroImageContainer: "hero-image-container flex-1 relative self-stretch",
  imageWrapper: "rounded-[3rem] overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.25)] relative h-full",
  heroImage: "w-full h-full object-cover object-center absolute inset-0",
  verifiedBadge:
  ...
  processSection: "py-16 bg-bg-main",
  ...
  processGrid: "process-grid grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-12 relative max-md:gap-14 pt-10",
  processCard:
